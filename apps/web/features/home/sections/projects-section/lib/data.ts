...
export const projects: Project[] = [
  ...
  {
    id: '6',
    title: 'AI Document & Meeting Analysis Platform',
    description:
      'Developed an AI-powered platform for analyzing documents and meeting recordings. Integrated OpenAI API for intelligent content extraction, summarization, and actionable insights generation. Built features for automatic transcription, key points extraction, and smart document parsing to improve team productivity.',
    technologies: [
      'Next.js',
      'React.js',
      'TypeScript',
    ...
    features: [
      'AI-powered document analysis and content extraction using OpenAI API',
      'Automatic meeting transcription and summarization',
      'Key points and action items extraction from meetings',
      'Smart document parsing for structured data extraction',
      'Secure authentication with Google OAuth integration',
    ],
    imageUrl: '/images/projects/ai-documents/placeholder.png',
    images: ['/images/projects/ai-documents/placeholder.png'],
    githubUrl: '',
    liveUrl: '',
    category: PROJECT_CATEGORIES.AI,
    featured: true,
