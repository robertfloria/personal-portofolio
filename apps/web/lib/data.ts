...
export const personalInfo: PersonalInfo = {
  ...
  bio: 'Software Engineer with over 4 years of experience in developing scalable web and mobile applications. Enhanced delivery speed by up to 30% through the use of AI-powered development tools with technologies such as React.js, Next.js, TypeScript, Node.js, NestJS and React Native (Expo). Proficient in CI/CD automation (utilizing GitHub Actions and Jenkins), cloud deployments, and containerization. Passionate about creating high-performance, user-centric solutions and promoting AI adoption within contemporary development workflows.',
  about:
