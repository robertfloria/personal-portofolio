...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        primary:
          'bg-linear-to-r from-primary to-accent text-primary-foreground hover:shadow-primary-strong hover:shadow-accent-strong hover:-translate-y-1',
        secondary:
          'border-2 border-border text-foreground hover:border-border hover:bg-card/5',
        outline:
