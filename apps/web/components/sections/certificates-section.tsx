      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {certificates.map((certificate, index) => (
            ...
            >
              <div className="relative h-48 bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center p-6">
                <div className="text-white text-center">
                  <div className="text-4xl font-bold mb-2">🏆</div>
                  <div className="text-sm opacity-80">{certificate.organization}</div>
                </div>
              ...
              <div className="p-6">
                <h3 className="text-lg font-bold mb-2 text-gray-900 dark:text-white line-clamp-2 min-h-[3.5rem]">
                  {certificate.title}
                </h3>
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-gradient-to-br from-green-500 to-blue-600 rounded-lg p-12 text-center text-white">
                  <div className="text-6xl mb-4">📜</div>
                  <p className="text-lg font-semibold">{selectedCertificate.title}</p>
                  <p className="text-sm opacity-80 mt-2">{selectedCertificate.organization}</p>
                </div>
